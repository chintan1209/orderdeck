...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [995, 26, 534, 369, 804, 680, 121, 288, 42, 50, 287, 824, 58, 114, 443, 838, 685, 858, 102], {
        2937: (e, t, n) => {
            e.exports = n(7841)
        },
        3774: (e, t, n) => {
        ...
        8949: (e, t, n) => {
            ...
            A || (F = function Promise(e) {
                ...
                Promise: F
            }), n(2280)(F, w), n(4472)(w), s = n(7252).Promise, d(d.S + d.F * !A, w, {
                ...
                d = function(e) {
                    ...
                    return (0, s.default)(lottieHandler, [{
                        ...
                        value: function setLinkTimeout() {
                            ...
                            "on_click" === n.trigger && (null === (e = n.custom_link) || void 0 === e ? void 0 : e.url) && n.link_timeout && this.elements.$containerLink.on("click", (function(e) {
        ...
        2731: (e, t, n) => {
            ...
            var o = i(n(1959)),
                ...
                g = function(e) {
                    ...
                    function _default() {
                        return (0, o.default)(this, _default), n.apply(this, arguments)
                    }
                    return (0, l.default)(_default, [{
                        ...
                        value: function initTriggers() {
                            this.triggers = new f.default(this.getDocumentSettings("triggers"), this)
                        }
                    }, {
                        key: "showModal",
                        value: function showModal(e) {
                            ...
                            n.setMessage(this.$element).show(), this.isEdit || (t.close_button_delay && (i.hide(), clearTimeout(this.closeButtonTimeout), this.closeButtonTimeout = setTimeout((function() {
                                return i.show()
                            }), 1e3 * t.close_button_delay)), (0, u.default)((0, c.default)(_default.prototype), "runElementsHandlers", this).call(this)), this.setEntranceAnimation(), t.timing && t.timing.times_count || this.countTimes(), elementorProFrontend.modules.popup.popupPopped = !0
                        }
                    }, {
                        ...
                        value: (t = (0, s.default)(a.default.mark((function _callee() {
                            return a.default.wrap((function _callee$(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if ((0, u.default)((0, c.default)(_default.prototype), "onInit", this).call(this), window.DialogsManager) {
                                            e.next = 4;
                                            break
                                        }
        ...
        9327: (e, t, n) => {
            ...
            var a, s = i(n(9117)),
                o = elementorModules.frontend.handlers.Base.extend({
                    onInit: (a = (0, s.default)(r.default.mark((function _callee() {
                        var e, t, n, i, a = arguments;
                        return r.default.wrap((function _callee$(r) {
                            for (;;) switch (r.prev = r.next) {
                                case 0:
                                    if (this.isActive()) {
                                    ...
                                    return r.abrupt("return");
                                case 2:
                                    if (elementorModules.frontend.handlers.Base.prototype.onInit.apply(this, a), e = this.getElementSettings(), t = this.getSettings("classes"), n = e.share_url && e.share_url.url, i = {
                                            classPrefix: t.shareLinkPrefix
                                        }, n ? i.url = e.share_url.url : (i.url = location.href, i.title = elementorFrontend.config.post.title, i.text = elementorFrontend.config.post.excerpt, i.image = elementorFrontend.config.post.featuredImage), window.ShareLink || !elementorFrontend.utils.assetsLoader) {
                                        r.next = 8;
                                        break
                                    }
                                    return r.next = 8, elementorFrontend.utils.assetsLoader.load("script", "share-link");
                                case 8:
            ...
            var a = i(n(1959)),
                ...
                d = function(e) {
                    ...
                    return (0, s.default)(TOCHandler, [{
                        ...
                        value: function onInit() {
                            for (var e, t = this, n = arguments.length, i = new Array(n), r = 0; r < n; r++) i[r] = arguments[r];
                            (e = (0, o.default)((0, l.default)(TOCHandler.prototype), "onInit", this)).call.apply(e, [this].concat(i)), this.viewportItems = [], jQuery((function() {
                                return t.run()
                            }))
                        }
                    }, {
