    ...
    constructor(classes) {
        ...
        this.duration = '1000',
            ...
            jQuery.each(arr_classes, (index, value) => {
                ...
                if ('de_scroll_translateX_popover_checked' === value) {
                    this.translateX = true
                }
                if ('de_scroll_translateY_popover_checked' === value) {
                    this.translateY = true
                }
                if ('de_scroll_translateZ_popover_checked' === value) {
                    this.translateZ = true
                }
                if ('de_scroll_rotate_popover_checked' === value) {
                    this.rotate = true
                }
                if ('de_scroll_rotateX_popover_checked' === value) {
                    this.rotateX = true
                }
                if ('de_scroll_rotateY_popover_checked' === value) {
                    this.rotateY = true
                }
                if ('de_scroll_rotateZ_popover_checked' === value) {
                    this.rotateZ = true
                }
                if ('de_scroll_scale_popover_checked' === value) {
                    this.scale = true
                }
                if ('de_scroll_scaleX_popover_checked' === value) {
                    this.scaleX = true
                }
                if ('de_scroll_scaleY_popover_checked' === value) {
                    this.scaleY = true
                }
                if ('de_scroll_scaleZ_popover_checked' === value) {
                    this.scaleZ = true
                }
                if ('de_scroll_skew_popover_checked' === value) {
                    this.skew = true
                }
                if ('de_scroll_skewX_popover_checked' === value) {
                    this.skewX = true
                }
                if ('de_scroll_skewY_popover_checked' === value) {
                    this.skewY = true
                }
